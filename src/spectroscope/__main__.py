...
from spectroscope.settings import SpectroScopeSettings
from spectroscope.smoothing import SpectroScopeSmoothing
...
class SpectroScopeMainWindow(QtWidgets.QMainWindow, Ui_SpectroScopeMainWindow):
    """SpectroScope main window"""
...
def main():
    ...
    try:
        ...
        if sys.platform == 'win32' and not debug:
            from spectroscope import windows
