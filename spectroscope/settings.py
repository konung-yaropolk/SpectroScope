...
class SpectroScopeSettings(QtWidgets.QDialog, Ui_SpectroScopeSettings):
    ...
    def on_paramsHelpButton_clicked(self):
        ...
        self.params_help_dialog = SpectroScopeSettingsHelp(
    ...
    def on_deviceHelpButton_clicked(self):
        ...
        self.device_help_dialog = SpectroScopeSettingsHelp(
...
class SpectroScopeSettingsHelp(QtWidgets.QDialog, Ui_SpectroScopeSettingsHelp):
    """SpectroScope settings help dialog"""
